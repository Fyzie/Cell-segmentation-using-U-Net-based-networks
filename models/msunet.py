...
def decoder_block(input1, input2, feature, kernel1, kernel2, dropout):
    ...
    c = encoder_block(u, feature, kernel1, kernel2, dropout)
    return c
...
def segment_model(IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS, kernel1=3, kernel2=5):
    ...
    c2 = encoder_block(p1, 32, kernel1, kernel2, 0.3)
    p2 = MaxPooling2D((2, 2))(c2)

    c3 = encoder_block(p2, 64, kernel1, kernel2, 0.3)
    p3 = MaxPooling2D((2, 2))(c3)

    c4 = encoder_block(p3, 128, kernel1, kernel2, 0.3)
