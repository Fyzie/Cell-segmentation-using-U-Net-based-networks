...
def segment_model(IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS):
    ...
    c1 = Conv2D(16, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(s)
    c1 = Dropout(dropout)(c1)
    c1 = Conv2D(16, (9, 9), activation='relu', kernel_initializer='he_normal', padding = 'same')(c1)
    p1 = MaxPooling2D((2,2))(c1)
    
    c2 = Conv2D(32, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(p1)
    c2 = Dropout(dropout)(c2)
    c2 = Conv2D(32, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c2)
    p2 = MaxPooling2D((2,2))(c2)
    
    c3 = Conv2D(64, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(p2)
    c3 = Dropout(dropout)(c3)
    c3 = Conv2D(64, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c3)
    p3 = MaxPooling2D((2,2))(c3)
    
    c4 = Conv2D(128, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(p3)
    c4 = Dropout(dropout)(c4)
    c4 = Conv2D(128, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c4)
    p4 = MaxPooling2D((2,2))(c4)
    
    c5 = Conv2D(256, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(p4)
    c5 = Dropout(dropout)(c5)
    c5 = Conv2D(256, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c5)
    
    c6 = Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same')(c5)
    c6 = concatenate([c6, c4])
    c6 = Conv2D(128, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c6)
    c6 = Dropout(dropout)(c6)
    c6 = Conv2D(128, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c6)
    
    c7 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same')(c6)
    c7 = concatenate([c7, c3])
    c7 = Conv2D(64, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c7)
    c7 = Dropout(dropout)(c7)
    c7 = Conv2D(64, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c7)
    
    c8 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same')(c7)
    c8 = concatenate([c8, c2])
    c8 = Conv2D(32, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c8)
    c8 = Dropout(dropout)(c8)
    c8 = Conv2D(32, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c8)
    
    c9 = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding='same')(c8)
    c9 = concatenate([c9, c1])
    c9 = Conv2D(16, (9, 9), activation='relu', kernel_initializer='he_normal', padding='same')(c9)
