...
def encoder_block(input1, feature, kernel, dropout):
    ...
    # Scale 1
    c1 = Conv2D(feature, (kernel, kernel), activation='relu', kernel_initializer='he_normal', padding='same')(input1)
    c1 = Dropout(dropout)(c1)
    c1 = Conv2D(feature, (kernel, kernel), activation='relu', kernel_initializer='he_normal', padding='same')(c1)
    
    # Scale 2 - 2 residual
    # input2 = Conv2D(feature, (1,1), activation='relu', kernel_initializer='he_normal', padding='same')(input1)
    # c2 = Conv2D(feature, (kernel, kernel), activation='relu', kernel_initializer='he_normal', padding='same', dilation_rate = 2)(input1)
    # c2 = Add()([c2, input2])
    # c2 = Dropout(dropout)(c2)
    # input3 = Conv2D(feature, (1,1), activation='relu', kernel_initializer='he_normal', padding='same')(c2)
    ...
    # c2 = Conv2D(feature, (kernel, kernel), activation='relu', kernel_initializer='he_normal', padding='same', dilation_rate = 2)(input1)
    # c2 = Add()([c2, input2])
    # d2 = Dropout(dropout)(c2)
    # c2 = Conv2D(feature, (kernel, kernel), activation='relu', kernel_initializer='he_normal', padding='same', dilation_rate = 2)(d2)
    # c2 = Add()([c2, d2])
