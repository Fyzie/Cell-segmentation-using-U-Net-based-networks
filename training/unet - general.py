...
###############################################################################################
def run_trials(data_directory, model_directory, trial_num, kernel_size, image_magnification, type_model):
...
for t in range(trials_left):
    data = run_trials(data_directory, model_directory, init_num, kernel_size, image_magnification, type_model)
    table.append(data)
    init_num += 1
...
for trial_num in range(10):
    trial_num += 1
    model_directory = 'D:/Pycharm Projects/Cell Segmentation/4-model/%s/%s/%s/' % (type_model, image_magnification, trial_num)
